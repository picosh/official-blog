...
[Lab](https://pico.sh/lab) is where we will showcase experimental ideas, projects, and oss libs.
...
- [pobj](https://github.com/picosh/pobj) - `rsync`, `scp`, `sftp` for your object store
- [ptun](https://github.com/picosh/ptun) - passwordless authentication experience for the browser
